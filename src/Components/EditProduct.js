            ...
            <div className='AdminBody'>
                ...
                <form className='InputFields' onSubmit={handleSubmit} >
                    ...
                    <div className='Field f2'>
                        ...
                        {img && !file && <img src={img} alt="product" style={{ width: "100px", marginTop: "10px" }} />}
                    </div>
                    <div className='Field f3'>
                        <p>Colour :</p>
                        <input type='text' placeholder='Enter Product Colour' name='Color' onChange={handleChange} value={Color} error={errors.Color ? { content: errors.Color } : null} />
                    </div>
                    <div className='Field f4'>
                        <p>Price :</p>
                        <input type="text" placeholder='Enter Price' name='Price' onChange={handleChange} value={Price} error={errors.Price ? { content: errors.Price } : null} />
                    </div>
